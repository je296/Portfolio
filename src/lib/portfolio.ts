...
export const projects = [
  {
    ...
    responsibility:
      "I developed frontend pages, backend APIs, internal reports, and Azure Data Factory batch jobs. I also optimized a migration feature working with approximately 10 million database records, reducing a slow query from minutes to under a millisecond by adding a database index and refining the GraphQL query.",
    challenge:
